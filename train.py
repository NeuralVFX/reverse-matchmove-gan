...
parser.add_argument('--train_gen_every', nargs='?', default=4, type=int)
...
parser.add_argument('--l1_weight', nargs='?', default=.001, type=float)
...
parser.add_argument('--disc_perceptual_weight', nargs='?', default=2.5, type=float)
