...
class ReverseMatchmove:
    ...
    def __init__(self, params):
        ...
        disc_convs = [list(self.model_dict['D'].children())[0][1],
                      ...
                      list(list(self.model_dict['D'].children())[0][3].children())[0],
                      list(list(self.model_dict['D'].children())[0][3].children())[1],
                      list(list(self.model_dict['D'].children())[0][3].children())[2],
